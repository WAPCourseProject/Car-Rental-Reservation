...
<head>
    ...
    <title>CRRC- Dashboard</title>
    <link rel="icon" type="image/x-icon" href="https://bernietes.github.io/res/front/assets/img/favicon.png"/>
    <!-- Custom fonts for this template-->
    <link href="https://bernietes.github.io/res/back/vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
          type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
          rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="https://bernietes.github.io/res/back/css/sb-admin-2.min.css" rel="stylesheet">
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard">
            ...
            <div class="sidebar-brand-text mx-3">Car Rental Reservation<sup>2</sup></div>
        </a>
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="mr-3">
                                    <div class="icon-circle bg-primary">
                                        <i class="fas fa-file-alt text-white">3</i>
                                    </div>
                                </div>
                                <div>
                ...
                <div class="main-panel">
                    ...
                    <div class="content">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-15 mx-auto mt-lg-3">
                                    <div class="card">
...
" href="edit?vehicleId=${vehicle.vehicleId}">Edit</a></td>
                                                        ...
                                                        <td><a
                                                                ...
                                                                onclick="return confirm('Are you sure you want to delete this Record?')" href="deleteVehicle?vehicleId=${vehicle.vehicleId}">Delete</a></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabell">Add new Car</h5>
                    ...
                    <form class="text-center" style="color: #757575;" action="#">
                        <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <button id="btn_add" type="submit" class="btn btn-success">Add Car</button>
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; MIU JUN-2020</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<script src="https://bernietes.github.io/res/back/vendor/jquery/jquery.min.js"></script>
<script src="https://bernietes.github.io/res/back/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

<!-- Core plugin JavaScript-->
<script src="https://bernietes.github.io/res/back/vendor/jquery-easing/jquery.easing.min.js"></script>

<!-- Custom scripts for all pages-->
<script src="https://bernietes.github.io/res/back/js/sb-admin-2.min.js"></script>
