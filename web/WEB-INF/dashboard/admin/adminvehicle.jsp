...
<head>
    ...
    <link href="https://bernietes.github.io/res/back/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
                        ...
                        <div class="modal-content">
                            ...
                            <form class="text-center" style="color: #757575;" action="#">
                                <div class="modal-body">
                                    ...
                                    <div>
                                        <div>
                                            <label for="price">RentPrice</label> <input type="number" id="price"
                                                                                        placeholder="price"/>
                                        </div>
                                    ...
                                    <div >
                                        <button type="submit" id="btn_add" type="submit">Add </button>
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabell">Ready to Leave?</h5>
